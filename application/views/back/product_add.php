...
<head>
    ...
    <title>Carts24X7 | Product Add</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<ul class="nav navbar-right panel_toolbox">
						<li><a href="<?php echo base_url()?>admin/product/list" class="close-link"><i class="fa fa-plus"></i>Product List</a></li>
					</ul>
                  <div class="x_content">
                    <br />
					
                    <form method="post" action="<?php echo base_url(); ?>index.php/admin/product/do_add"  enctype="multipart/form-data" class="form-horizontal form-label-left">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							<select class="form-control" id="subcat_id" name="subcat_name">
              <option value="">--Select--</option>
								<?php
                $sub=$this->db->query("select * from subcategory_list");
                foreach($sub->result_array() as $row2){  
                ?>
                <option value="<?php echo $row2['id']; ?>"><?php echo $row2['subcategoryname'];?></option>
                <?php } ?>
							</select>
                        </div>
                      </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="image2" class="form-control col-md-7 col-xs-12">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="image3" class="form-control col-md-7 col-xs-12">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="image4" class="form-control col-md-7 col-xs-12">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="image5" class="form-control col-md-7 col-xs-12">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <textarea rows="3" cols="50" class="form-control col-md-7 col-xs-12 ckeditor" name="short_description"></textarea>
                        </div>
                      </div>
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <textarea rows="3" cols="50" class="form-control col-md-7 col-xs-12 ckeditor" name="long_description"></textarea>
                        </div>
                      </div>
                    ...
                    <textarea rows="2" cols="50" class="form-control col-md-7 col-xs-12" name="attribute1"></textarea>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <textarea rows="2" cols="50" class="form-control col-md-7 col-xs-12" name="attribute2"></textarea>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <textarea rows="3" cols="50" class="form-control col-md-7 col-xs-12" name="attribute3"></textarea>
                    </div>
                    </div>
