                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
				  	...
				  	?> 
                        <tr>
                          ...
                          <td><a href="<?php echo base_url()?>index.php/admin/package/edit/<?php echo $row['id']; ?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> | 
								<a href="<?php echo base_url()?>index.php/admin/package/delete/<?php echo $row['id']; ?>" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>
