...
<head>
    ...
    <title>Carts24X7 | SubCategory Add</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<ul class="nav navbar-right panel_toolbox">
						<li><a href="<?php echo base_url()?>admin/subcategory/list" class="close-link"><i class="fa fa-plus"></i>SubCategory List</a></li>
					</ul>
                  <div class="x_content">
                    <br />
					
                    <form method="post" action="<?php echo base_url(); ?>index.php/admin/subcategory/do_add"  enctype="multipart/form-data" class="form-horizontal form-label-left">
