              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					?>
                    <form method="post" action="<?php echo base_url(); ?>index.php/admin/category/do_update/<?php echo $row['id']; ?>"  enctype="multipart/form-data" class="form-horizontal form-label-left">
