                                        ...
                                        <form method="post" action="<?php echo base_url(); ?>admin/updateSong/<?php echo $songDetail['id']; ?>"  enctype="multipart/form-data" class="form-horizontal form-label-left">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <select name="lyricist" class="form-control">
                                                        ...
                                                        <?php foreach($getLyricist as $allLyricist){?>
                                                            <option value="<?php echo $allLyricist->id; ?>" <?php if($songDetail['lyricist']==$allLyricist->id){ echo "selected"; } ?> ><?php echo $allLyricist->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <select name="composer" class="form-control">
                                                        ...
                                                        <?php foreach($getComposer as $allComposer){?>
                                                            <option value="<?php echo $allComposer->id; ?>" <?php if($songDetail['composer']==$allComposer->id){ echo "selected"; } ?>><?php echo $allComposer->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <select name="music" class="form-control">
                                                        ...
                                                        <?php foreach($getMusic as $allMusic){?>
                                                            <option value="<?php echo $allMusic->id; ?>" <?php if($songDetail['music']==$allMusic->id){ echo "selected"; } ?> ><?php echo $allMusic->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="file" class="form-control col-md-7 col-xs-12" name="song_file">
                                                    <img src="<?=base_url('assets/thumbnail/320X320/'.$songDetail['thumbnail_320X320']);?>" alt="" height="100px" width="100px">
                                                    <img src="<?=base_url('assets/thumbnail/128X128/'.$songDetail['thumbnail_128X128']);?>" alt="" height="100px" width="100px">
                                                </div>
                                            </div>
