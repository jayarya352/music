...
<div class="d-flex align-items-center">
    ...
    <ul class="header-options d-flex align-items-center">
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#login" class="language">
                <span>Login</span>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#register" class="language">
                <span>Register</span>
...
<!-- Begin | Login Modal -->
<div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="langTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(110deg, #ffffff 50%, #ffed4b 50%);">
                <div>
                    <h5 class="modal-title mb-1" id="langTitle">Login</h5>
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="langTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(110deg, #ffffff 50%, #ffed4b 50%);">
                <div>
                    <h5 class="modal-title mb-1" id="langTitle">Register</h5>
