                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        <div class="flex-grow-1">
                            <h4>Dance with DJ Nowan</h4>
                            <p>Free Event</p>
                        </div>
                        <a href="songs.html" class="btn btn-bold btn-pill btn-air btn-warning">Buy now</a>
                    </div>
                    <hr>
                </div>
                <div class="row">
                    <div class="col-sm-5">
                        <div class="event event-h bg-img bg-img-radius-lg mb-4" style="background-image: url('../assets/images/background/horizontal/1.jpg')"></div>
                        <div class="mb-3">
                            <b>Venue At</b>
