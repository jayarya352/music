        ...
        <div class="main-container" id="appRoute">
            <div class="row section text-center text-md-left">
                ...
                <?php foreach($songDetail as $song_detail) ?>
                    ...
                    <img src="<?php echo base_url();  ?>assets/thumbnail/320X320/<?php echo $song_detail['thumbnail_320X320']; ?>" alt="" class="card-img--radius-lg">
                </div>
                <div class="col-xl-9 col-lg-8 col-sm-7">
                    <div class="row pt-4">
                        <div class="col-xl-8 col-lg-6">
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0);" class="btn btn-pill btn-air btn-bold btn-danger external" data-audio='{"name": "<?php echo $song_detail['name']; ?>", "artist": "Gerrina Linda", "album": "Hot Shot", "url": "<?php echo base_url();  ?>assets/songs/<?php echo $song_detail['filename']; ?>", "cover_art_url": "<?php echo base_url();  ?>assets/thumbnail/128X128/<?php echo $song_detail['thumbnail_128X128']; ?>"}'>Play</a>
                            </div>
                        </div>
            ...
            <div class="section">
                ...
                <div class="d-flex mb-4">
                    <div class="avatar avatar-sm avatar-circle">
                        <img src="<?php echo base_url();  ?>assets/images/users/thumb.jpg" alt="">
                    </div>
