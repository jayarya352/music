    ...
    <main id="pageWrapper">
        ...
        <div class="main-container" id="appRoute">
            ...
            <div class="row section">
                <div class="col-xl-3 col-md-5 pb-4">
                ...
                <div class="col-xl-5 col-md-7">
                    ...
                    <div class="pb-4">
                        <div class="event event-h bg-img bg-img-radius-lg" style="background-image: url('../assets/images/background/horizontal/2.jpg')">
                            <div class="event-content p-4">
                ...
                <div class="col-xl-4 col-md-7 pb-4">
                    <div class="h-100 event event-v bg-img bg-img-radius-lg" style="background-image: url('../assets/images/background/vertical/1.jpg')">
                        <div class="event-content p-4">
                            <a href="event-details.html"><h6>New Year Party</h6></a>
                            <span class="countdown mb-3"></span>
