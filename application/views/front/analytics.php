...
<div id="wrapper" data-scrollable="true">
    ...
    <main id="pageWrapper">
        ...
        <div class="main-container" id="appRoute">
            ...
            <div class="section">
                <div class="mb-5">
                    <h5>Hi <span class="text-brand">Admin</span>, Welcome to the Listen App</h5>
                        ...
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <h6 class="text-white mb-0">Total Earnings</h6>
                                ...
                                <button type="button" class="btn btn-pill btn-air btn-warning">Get Details</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="font-weight-bold pl-2">10,245</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="font-weight-bold pl-2">58,415</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card bg-warning">
                                    <div class="card-body">
                                        <h6>Purchases</h6>
                                        <div class="d-flex align-items-center">
                                            <i class="ion-md-cash font-lg"></i>
                                            <p class="font-weight-bold pl-2">11,012,547</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <span class="font-weight-bold d-block mt-3">Top Countries</span>
                                    <div class="row">
                                        <div class="col-4 border-right">
                                            <div class="py-2 px-sm-3">
                                                <span class="d-block">USA</span>
                                                <p class="font-weight-bold">1,243</p>
                                            </div>
                                        </div>
                                        <div class="col-4 border-right">
                                            <div class="py-2 px-sm-3">
                                                <span class="d-block">UK</span>
                                                <p class="font-weight-bold">643</p>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="py-2 px-sm-3">
                                                <span class="d-block">Russia</span>
                                                <p class="font-weight-bold">351</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item border-0 px-0 pb-0">
                                        <p class="font-lg mb-2">2401</p>
                                        <p>Visits from Instagram</p>
                                        <div class="progress mb-2" style="height: .25rem">
                                            <div class="progress-bar bg-brand" role="progressbar" style="width: 67%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                    <li class="list-group-item border-0 px-0 pb-0">
                                        <p class="font-lg mb-2">975</p>
                                        <p>Visits from Twitter</p>
                                        <div class="progress mb-2" style="height: .25rem">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 31%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                    <li class="list-group-item border-0 px-0 pb-0">
                                        <p class="font-lg mb-2">1672</p>
                                        <p>Visits from Affiliates</p>
                                        <div class="progress mb-2" style="height: .25rem">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 52%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
